...
After those steps are complete you need to add your own TMDB API key:

* Go to https://www.themoviedb.org/
* Create an account
* Click on your profile and go to settings
* Scroll down and go to the 'API' section
* Below the 'API Key (v3 auth)', copy the API key
* Go back to the cloned repository and open a terminal there
